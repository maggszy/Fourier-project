...
include("C:\\Users\\natka\\studia\\sem2\\pakiety\\Furier\\Fourier-project\\naszmodul.jl")
...
function smooth_sound(cos)
    ...
    println("przeszl")
    s = Plots.plot(current_time_range,current2_sound)
...
signal_connect(smooth_close,accept_smooth,"clicked")
